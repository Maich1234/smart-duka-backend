 ...
 * opening/closing stock adjustment, because Smart Duka does not capture the
...
export async function buildProfitLoss({ shop, ownerName, from, to }) {
  ...
  const footnotes = [
    ...
    'Excludes depreciation, tax, and any opening/closing stock adjustment, none of which Smart Duka records.',
